<x-agent-layout :title="'Schedule Appointment'">
    ...
    <form method="POST" action="{{ route('appointments.store') }}" class="mt-6 max-w-3xl rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
        @csrf
        ...
        <div class="mt-6 flex items-center gap-3">
            ...
            <a href="{{ route('appointments.index') }}" class="text-sm font-medium text-gray-500 hover:text-gray-700">Cancel</a>
        </div>
    </form>
</x-agent-layout>
